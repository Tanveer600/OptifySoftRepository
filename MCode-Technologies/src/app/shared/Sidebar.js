    ...
    return (
      <nav className="sidebar sidebar-offcanvas" id="sidebar">
        <ul className="nav">
          <li className="nav-item nav-profile">
            <a href="!#" className="nav-link" onClick={evt => evt.preventDefault()}>
              ...
              <div className="nav-profile-text">
                <span className="font-weight-bold mb-2"><Trans>Sadaf IT. H</Trans></span>
          ...
          <li className={this.isPathActive('/user/login') ? 'nav-item active' : 'nav-item'}>
            <Link className="nav-link" to="/user/login">
              <span className="menu-title"><Trans>Login Page</Trans></span>
              <i className="mdi mdi-login menu-icon"></i>
            </Link>
          </li>
  <li className={this.isPathActive('/user/settings') ? 'nav-item active' : 'nav-item'}>
          ...
          <li className={this.isPathActive('/user-pages') ? 'nav-item active' : 'nav-item'}>
            ...
            <Collapse in={this.state.userPagesMenuOpen}>
              <ul className="nav flex-column sub-menu">
                ...
                <li className="nav-item"> <Link className={this.isPathActive('/user-pages/user') ? 'nav-link active' : 'nav-link'} to="/user-pages/user"><Trans>User</Trans></Link></li>
                 <li className="nav-item"> <Link className={this.isPathActive('/user-pages/permissionlist') ? 'nav-link active' : 'nav-link'} to="/user-pages/permissionlist"><Trans>Permission</Trans></Link></li>
                <li className="nav-item"> <Link className={this.isPathActive('/user-pages/role-permission-list') ? 'nav-link active' : 'nav-link'} to="/user-pages/role-permission-list"><Trans>Role Permission</Trans></Link></li>
